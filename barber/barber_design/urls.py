...
from .views import logout_view, user_view, get_skills_view, create_skill, delete_skill, create_visit, get_visits_view, delete_visit, register_view, login_view, set_skill, delete_user_skill, main_view
urlpatterns = [
